const self = self || {postMessage: () => {}};
  ...
  */
  ...
  class Element extends ParentNode {
    constructor(nodeType, nodeName, namespaceURI, ownerDocument) {
      super(nodeType, nodeName, ownerDocument);
      this.attributes = [];
      this[_a$4] = {};
    ...
    get outerHTML() {
      ...
      return `<${[tag, toString(this.attributes)].join(' ').trim()}>${this.innerHTML}</${tag}>`;
    }
    /**
  ...
  */
  ...
  class Document extends Element {
    ...
    createElementNS(namespaceURI, tagName) {
      ...
      return new (NODE_NAME_MAPPING[upperTagName] || HTMLElement)(1
      /* ELEMENT_NODE */
      , upperTagName, namespaceURI, this);
    }
  ...
  function create(document, strings, skeleton) {
    ...
    /* nodeType */
      ...
      default:
        ...
        const nodeName = strings[skeleton[1
        /* nodeName */
        ]];
